...
const LOCAL_PATH = "./tmp/CA1 - A311 - Death V2.pdf";
// For a folder, just put the folder path like "../tmp/my-folder"

// Firebase Storage folder
const STORAGE_DIR = "revision-summaries"; // <-- Change this to your desired storage folder

// Allowed file extensions
const ALLOWED_EXTENSIONS = [".xlsx", ".pdf"]; // <-- Change to any file types you want
